...
ANIME MENU 
${prefs}{prefix}pinterest2
${prefs}{prefix}boruto
${prefs}{prefix}hinata
${prefs}{prefix}sasuke
${prefs}{prefix}sakura
${prefs}prefix}kaneki
${prefs}{prefix}toukachan
${prefs}{prefix}rize
${prefs}{prefix}akira
${prefs}itori$
${prefs}kurumi
...
mans.sendMessage(from, { text: anu }, { quoted: fakeatakbot })
break
case 'xnxxvideo':
...
mans.sendList(m.chat, `Haii *${pushname}*`, `Silahkan Pilih Di Bawah`, "CLICK", "Fitur Nulis By XzyBotz-Store ", fejfjej, { quoted: m })
break
case 'nuliskiri':{
